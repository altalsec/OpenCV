...
//
- (int)registerOutput:(NSString*)outputName layerId:(int)layerId outputPort:(int)outputPort {
    int retVal = self.nativePtr->registerOutput(std::string(outputName.UTF8String), layerId, outputPort);
    return retVal;
}
