...
//
+ (Point2d*)phaseCorrelateIterative:(Mat*)src1 src2:(Mat*)src2 L2size:(int)L2size maxIters:(int)maxIters {
    cv::Point2d retVal = cv::phaseCorrelateIterative(src1.nativeRef, src2.nativeRef, L2size, maxIters);
    return [Point2d fromNative:retVal];
}

+ (Point2d*)phaseCorrelateIterative:(Mat*)src1 src2:(Mat*)src2 L2size:(int)L2size {
    cv::Point2d retVal = cv::phaseCorrelateIterative(src1.nativeRef, src2.nativeRef, L2size);
    return [Point2d fromNative:retVal];
}

+ (Point2d*)phaseCorrelateIterative:(Mat*)src1 src2:(Mat*)src2 {
    cv::Point2d retVal = cv::phaseCorrelateIterative(src1.nativeRef, src2.nativeRef);
    return [Point2d fromNative:retVal];
}
...
//
+ (double)thresholdWithMask:(Mat*)src dst:(Mat*)dst mask:(Mat*)mask thresh:(double)thresh maxval:(double)maxval type:(int)type {
    double retVal = cv::thresholdWithMask(src.nativeRef, dst.nativeRef, mask.nativeRef, thresh, maxval, type);
    return retVal;
}
...
//
+ (double)minEnclosingConvexPolygon:(Mat*)points polygon:(Mat*)polygon k:(int)k {
    double retVal = cv::minEnclosingConvexPolygon(points.nativeRef, polygon.nativeRef, k);
    return retVal;
}
...
//
+ (void)getClosestEllipsePoints:(RotatedRect*)ellipse_params points:(Mat*)points closest_pts:(Mat*)closest_pts {
    cv::getClosestEllipsePoints(ellipse_params.nativeRef, points.nativeRef, closest_pts.nativeRef);
}
...
//
+ (void)HoughLinesWithAccumulator:(Mat*)image lines:(Mat*)lines rho:(double)rho theta:(double)theta threshold:(int)threshold srn:(double)srn stn:(double)stn min_theta:(double)min_theta max_theta:(double)max_theta use_edgeval:(BOOL)use_edgeval {
    cv::HoughLinesWithAccumulator(image.nativeRef, lines.nativeRef, rho, theta, threshold, srn, stn, min_theta, max_theta, (bool)use_edgeval);
}
...
//
+ (void)HoughCirclesWithAccumulator:(Mat*)image circles:(Mat*)circles method:(int)method dp:(double)dp minDist:(double)minDist param1:(double)param1 param2:(double)param2 minRadius:(int)minRadius maxRadius:(int)maxRadius {
    cv::HoughCirclesWithAccumulator(image.nativeRef, circles.nativeRef, method, dp, minDist, param1, param2, minRadius, maxRadius);
}

+ (void)HoughCirclesWithAccumulator:(Mat*)image circles:(Mat*)circles method:(int)method dp:(double)dp minDist:(double)minDist param1:(double)param1 param2:(double)param2 minRadius:(int)minRadius {
    cv::HoughCirclesWithAccumulator(image.nativeRef, circles.nativeRef, method, dp, minDist, param1, param2, minRadius);
}

+ (void)HoughCirclesWithAccumulator:(Mat*)image circles:(Mat*)circles method:(int)method dp:(double)dp minDist:(double)minDist param1:(double)param1 param2:(double)param2 {
    cv::HoughCirclesWithAccumulator(image.nativeRef, circles.nativeRef, method, dp, minDist, param1, param2);
}

+ (void)HoughCirclesWithAccumulator:(Mat*)image circles:(Mat*)circles method:(int)method dp:(double)dp minDist:(double)minDist param1:(double)param1 {
    cv::HoughCirclesWithAccumulator(image.nativeRef, circles.nativeRef, method, dp, minDist, param1);
}

+ (void)HoughCirclesWithAccumulator:(Mat*)image circles:(Mat*)circles method:(int)method dp:(double)dp minDist:(double)minDist {
    cv::HoughCirclesWithAccumulator(image.nativeRef, circles.nativeRef, method, dp, minDist);
}
