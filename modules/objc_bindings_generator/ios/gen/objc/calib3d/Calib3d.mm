...
+ (int)CALIB_DISABLE_SCHUR_COMPLEMENT {
    return (1 << 23);
}
...
//
+ (Double2*)estimateTranslation2D:(Mat*)from to:(Mat*)to inliers:(Mat*)inliers method:(int)method ransacReprojThreshold:(double)ransacReprojThreshold maxIters:(size_t)maxIters confidence:(double)confidence refineIters:(size_t)refineIters {
    cv::Vec2d retVal = cv::estimateTranslation2D(from.nativeRef, to.nativeRef, inliers.nativeRef, method, ransacReprojThreshold, maxIters, confidence, refineIters);
    return [Double2 fromNative:retVal];
}

+ (Double2*)estimateTranslation2D:(Mat*)from to:(Mat*)to inliers:(Mat*)inliers method:(int)method ransacReprojThreshold:(double)ransacReprojThreshold maxIters:(size_t)maxIters confidence:(double)confidence {
    cv::Vec2d retVal = cv::estimateTranslation2D(from.nativeRef, to.nativeRef, inliers.nativeRef, method, ransacReprojThreshold, maxIters, confidence);
    return [Double2 fromNative:retVal];
}

+ (Double2*)estimateTranslation2D:(Mat*)from to:(Mat*)to inliers:(Mat*)inliers method:(int)method ransacReprojThreshold:(double)ransacReprojThreshold maxIters:(size_t)maxIters {
    cv::Vec2d retVal = cv::estimateTranslation2D(from.nativeRef, to.nativeRef, inliers.nativeRef, method, ransacReprojThreshold, maxIters);
    return [Double2 fromNative:retVal];
}

+ (Double2*)estimateTranslation2D:(Mat*)from to:(Mat*)to inliers:(Mat*)inliers method:(int)method ransacReprojThreshold:(double)ransacReprojThreshold {
    cv::Vec2d retVal = cv::estimateTranslation2D(from.nativeRef, to.nativeRef, inliers.nativeRef, method, ransacReprojThreshold);
    return [Double2 fromNative:retVal];
}

+ (Double2*)estimateTranslation2D:(Mat*)from to:(Mat*)to inliers:(Mat*)inliers method:(int)method {
    cv::Vec2d retVal = cv::estimateTranslation2D(from.nativeRef, to.nativeRef, inliers.nativeRef, method);
    return [Double2 fromNative:retVal];
}

+ (Double2*)estimateTranslation2D:(Mat*)from to:(Mat*)to inliers:(Mat*)inliers {
    cv::Vec2d retVal = cv::estimateTranslation2D(from.nativeRef, to.nativeRef, inliers.nativeRef);
    return [Double2 fromNative:retVal];
}

+ (Double2*)estimateTranslation2D:(Mat*)from to:(Mat*)to {
    cv::Vec2d retVal = cv::estimateTranslation2D(from.nativeRef, to.nativeRef);
    return [Double2 fromNative:retVal];
}
...
//
+ (BOOL)fisheye_solvePnPRansac:(Mat*)objectPoints imagePoints:(Mat*)imagePoints cameraMatrix:(Mat*)cameraMatrix distCoeffs:(Mat*)distCoeffs rvec:(Mat*)rvec tvec:(Mat*)tvec useExtrinsicGuess:(BOOL)useExtrinsicGuess iterationsCount:(int)iterationsCount reprojectionError:(float)reprojectionError confidence:(double)confidence inliers:(Mat*)inliers flags:(int)flags criteria:(TermCriteria*)criteria {
    bool retVal = cv::fisheye::solvePnPRansac(objectPoints.nativeRef, imagePoints.nativeRef, cameraMatrix.nativeRef, distCoeffs.nativeRef, rvec.nativeRef, tvec.nativeRef, (bool)useExtrinsicGuess, iterationsCount, reprojectionError, confidence, inliers.nativeRef, flags, criteria.nativeRef);
    return retVal;
}

+ (BOOL)fisheye_solvePnPRansac:(Mat*)objectPoints imagePoints:(Mat*)imagePoints cameraMatrix:(Mat*)cameraMatrix distCoeffs:(Mat*)distCoeffs rvec:(Mat*)rvec tvec:(Mat*)tvec useExtrinsicGuess:(BOOL)useExtrinsicGuess iterationsCount:(int)iterationsCount reprojectionError:(float)reprojectionError confidence:(double)confidence inliers:(Mat*)inliers flags:(int)flags {
    bool retVal = cv::fisheye::solvePnPRansac(objectPoints.nativeRef, imagePoints.nativeRef, cameraMatrix.nativeRef, distCoeffs.nativeRef, rvec.nativeRef, tvec.nativeRef, (bool)useExtrinsicGuess, iterationsCount, reprojectionError, confidence, inliers.nativeRef, flags);
    return retVal;
}

+ (BOOL)fisheye_solvePnPRansac:(Mat*)objectPoints imagePoints:(Mat*)imagePoints cameraMatrix:(Mat*)cameraMatrix distCoeffs:(Mat*)distCoeffs rvec:(Mat*)rvec tvec:(Mat*)tvec useExtrinsicGuess:(BOOL)useExtrinsicGuess iterationsCount:(int)iterationsCount reprojectionError:(float)reprojectionError confidence:(double)confidence inliers:(Mat*)inliers {
    bool retVal = cv::fisheye::solvePnPRansac(objectPoints.nativeRef, imagePoints.nativeRef, cameraMatrix.nativeRef, distCoeffs.nativeRef, rvec.nativeRef, tvec.nativeRef, (bool)useExtrinsicGuess, iterationsCount, reprojectionError, confidence, inliers.nativeRef);
    return retVal;
}

+ (BOOL)fisheye_solvePnPRansac:(Mat*)objectPoints imagePoints:(Mat*)imagePoints cameraMatrix:(Mat*)cameraMatrix distCoeffs:(Mat*)distCoeffs rvec:(Mat*)rvec tvec:(Mat*)tvec useExtrinsicGuess:(BOOL)useExtrinsicGuess iterationsCount:(int)iterationsCount reprojectionError:(float)reprojectionError confidence:(double)confidence {
    bool retVal = cv::fisheye::solvePnPRansac(objectPoints.nativeRef, imagePoints.nativeRef, cameraMatrix.nativeRef, distCoeffs.nativeRef, rvec.nativeRef, tvec.nativeRef, (bool)useExtrinsicGuess, iterationsCount, reprojectionError, confidence);
    return retVal;
}

+ (BOOL)fisheye_solvePnPRansac:(Mat*)objectPoints imagePoints:(Mat*)imagePoints cameraMatrix:(Mat*)cameraMatrix distCoeffs:(Mat*)distCoeffs rvec:(Mat*)rvec tvec:(Mat*)tvec useExtrinsicGuess:(BOOL)useExtrinsicGuess iterationsCount:(int)iterationsCount reprojectionError:(float)reprojectionError {
    bool retVal = cv::fisheye::solvePnPRansac(objectPoints.nativeRef, imagePoints.nativeRef, cameraMatrix.nativeRef, distCoeffs.nativeRef, rvec.nativeRef, tvec.nativeRef, (bool)useExtrinsicGuess, iterationsCount, reprojectionError);
    return retVal;
}

+ (BOOL)fisheye_solvePnPRansac:(Mat*)objectPoints imagePoints:(Mat*)imagePoints cameraMatrix:(Mat*)cameraMatrix distCoeffs:(Mat*)distCoeffs rvec:(Mat*)rvec tvec:(Mat*)tvec useExtrinsicGuess:(BOOL)useExtrinsicGuess iterationsCount:(int)iterationsCount {
    bool retVal = cv::fisheye::solvePnPRansac(objectPoints.nativeRef, imagePoints.nativeRef, cameraMatrix.nativeRef, distCoeffs.nativeRef, rvec.nativeRef, tvec.nativeRef, (bool)useExtrinsicGuess, iterationsCount);
    return retVal;
}

+ (BOOL)fisheye_solvePnPRansac:(Mat*)objectPoints imagePoints:(Mat*)imagePoints cameraMatrix:(Mat*)cameraMatrix distCoeffs:(Mat*)distCoeffs rvec:(Mat*)rvec tvec:(Mat*)tvec useExtrinsicGuess:(BOOL)useExtrinsicGuess {
    bool retVal = cv::fisheye::solvePnPRansac(objectPoints.nativeRef, imagePoints.nativeRef, cameraMatrix.nativeRef, distCoeffs.nativeRef, rvec.nativeRef, tvec.nativeRef, (bool)useExtrinsicGuess);
    return retVal;
}

+ (BOOL)fisheye_solvePnPRansac:(Mat*)objectPoints imagePoints:(Mat*)imagePoints cameraMatrix:(Mat*)cameraMatrix distCoeffs:(Mat*)distCoeffs rvec:(Mat*)rvec tvec:(Mat*)tvec {
    bool retVal = cv::fisheye::solvePnPRansac(objectPoints.nativeRef, imagePoints.nativeRef, cameraMatrix.nativeRef, distCoeffs.nativeRef, rvec.nativeRef, tvec.nativeRef);
    return retVal;
}
