...
- (instancetype)initWithSource:(IStreamReader*)source apiPreference:(int)apiPreference params:(IntVector*)params {
    return [self initWithNativePtr:cv::Ptr<cv::VideoCapture>(new cv::VideoCapture(source.nativePtr, apiPreference, params.nativeRef))];
}
...
//
- (BOOL)openWithStreamReader:(IStreamReader*)source apiPreference:(int)apiPreference params:(IntVector*)params {
    bool retVal = self.nativePtr->open(source.nativePtr, apiPreference, params.nativeRef);
    return retVal;
}
