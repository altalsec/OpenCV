...
//
+ (FaceRecognizerSF*)create:(NSString*)framework bufferModel:(ByteVector*)bufferModel bufferConfig:(ByteVector*)bufferConfig backend_id:(int)backend_id target_id:(int)target_id {
    cv::Ptr<cv::FaceRecognizerSF> retVal = cv::FaceRecognizerSF::create(cv::String(framework.UTF8String), (std::vector<uchar>&)bufferModel.nativeRef, (std::vector<uchar>&)bufferConfig.nativeRef, backend_id, target_id);
    return [FaceRecognizerSF fromNative:retVal];
}

+ (FaceRecognizerSF*)create:(NSString*)framework bufferModel:(ByteVector*)bufferModel bufferConfig:(ByteVector*)bufferConfig backend_id:(int)backend_id {
    cv::Ptr<cv::FaceRecognizerSF> retVal = cv::FaceRecognizerSF::create(cv::String(framework.UTF8String), (std::vector<uchar>&)bufferModel.nativeRef, (std::vector<uchar>&)bufferConfig.nativeRef, backend_id);
    return [FaceRecognizerSF fromNative:retVal];
}

+ (FaceRecognizerSF*)create:(NSString*)framework bufferModel:(ByteVector*)bufferModel bufferConfig:(ByteVector*)bufferConfig {
    cv::Ptr<cv::FaceRecognizerSF> retVal = cv::FaceRecognizerSF::create(cv::String(framework.UTF8String), (std::vector<uchar>&)bufferModel.nativeRef, (std::vector<uchar>&)bufferConfig.nativeRef);
    return [FaceRecognizerSF fromNative:retVal];
}
