...
-(float)tracking_score_threshold {
	return self.nativePtr->tracking_score_threshold;
}

-(void)setTracking_score_threshold:(float)tracking_score_threshold {
	self.nativePtr->tracking_score_threshold = tracking_score_threshold;
}
