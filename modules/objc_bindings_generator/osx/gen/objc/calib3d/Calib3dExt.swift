...
public extension Calib3d {
    @nonobjc class func fisheye_calibrate(objectPoints: [Mat], imagePoints: [Mat], image_size: Size2i, K: Mat, D: Mat, rvecs: inout [Mat], tvecs: inout [Mat], flags: Int32, criteria: TermCriteria) -> Double {
        let rvecsArray = NSMutableArray(array: rvecs)
        let tvecsArray = NSMutableArray(array: tvecs)
        let ret = Calib3d.fisheye_calibrate(objectPoints: objectPoints, imagePoints: imagePoints, image_size: image_size, K: K, D: D, rvecs: rvecsArray, tvecs: tvecsArray, flags: flags, criteria: criteria)
        rvecs.removeAll()
        rvecs.append(contentsOf: rvecsArray as! [Mat])
        tvecs.removeAll()
        tvecs.append(contentsOf: tvecsArray as! [Mat])
...
public extension Calib3d {
    @nonobjc class func fisheye_calibrate(objectPoints: [Mat], imagePoints: [Mat], image_size: Size2i, K: Mat, D: Mat, rvecs: inout [Mat], tvecs: inout [Mat], flags: Int32) -> Double {
        let rvecsArray = NSMutableArray(array: rvecs)
        let tvecsArray = NSMutableArray(array: tvecs)
        let ret = Calib3d.fisheye_calibrate(objectPoints: objectPoints, imagePoints: imagePoints, image_size: image_size, K: K, D: D, rvecs: rvecsArray, tvecs: tvecsArray, flags: flags)
        rvecs.removeAll()
        rvecs.append(contentsOf: rvecsArray as! [Mat])
        tvecs.removeAll()
        tvecs.append(contentsOf: tvecsArray as! [Mat])
...
public extension Calib3d {
    @nonobjc class func fisheye_calibrate(objectPoints: [Mat], imagePoints: [Mat], image_size: Size2i, K: Mat, D: Mat, rvecs: inout [Mat], tvecs: inout [Mat]) -> Double {
        let rvecsArray = NSMutableArray(array: rvecs)
        let tvecsArray = NSMutableArray(array: tvecs)
        let ret = Calib3d.fisheye_calibrate(objectPoints: objectPoints, imagePoints: imagePoints, image_size: image_size, K: K, D: D, rvecs: rvecsArray, tvecs: tvecsArray)
        rvecs.removeAll()
        rvecs.append(contentsOf: rvecsArray as! [Mat])
        tvecs.removeAll()
        tvecs.append(contentsOf: tvecsArray as! [Mat])
...
public extension Calib3d {
    @nonobjc class func fisheye_stereoCalibrate(objectPoints: [Mat], imagePoints1: [Mat], imagePoints2: [Mat], K1: Mat, D1: Mat, K2: Mat, D2: Mat, imageSize: Size2i, R: Mat, T: Mat, rvecs: inout [Mat], tvecs: inout [Mat], flags: Int32, criteria: TermCriteria) -> Double {
        let rvecsArray = NSMutableArray(array: rvecs)
        let tvecsArray = NSMutableArray(array: tvecs)
        let ret = Calib3d.fisheye_stereoCalibrate(objectPoints: objectPoints, imagePoints1: imagePoints1, imagePoints2: imagePoints2, K1: K1, D1: D1, K2: K2, D2: D2, imageSize: imageSize, R: R, T: T, rvecs: rvecsArray, tvecs: tvecsArray, flags: flags, criteria: criteria)
        rvecs.removeAll()
        rvecs.append(contentsOf: rvecsArray as! [Mat])
        tvecs.removeAll()
        tvecs.append(contentsOf: tvecsArray as! [Mat])
...
public extension Calib3d {
    @nonobjc class func fisheye_stereoCalibrate(objectPoints: [Mat], imagePoints1: [Mat], imagePoints2: [Mat], K1: Mat, D1: Mat, K2: Mat, D2: Mat, imageSize: Size2i, R: Mat, T: Mat, rvecs: inout [Mat], tvecs: inout [Mat], flags: Int32) -> Double {
        let rvecsArray = NSMutableArray(array: rvecs)
        let tvecsArray = NSMutableArray(array: tvecs)
        let ret = Calib3d.fisheye_stereoCalibrate(objectPoints: objectPoints, imagePoints1: imagePoints1, imagePoints2: imagePoints2, K1: K1, D1: D1, K2: K2, D2: D2, imageSize: imageSize, R: R, T: T, rvecs: rvecsArray, tvecs: tvecsArray, flags: flags)
        rvecs.removeAll()
        rvecs.append(contentsOf: rvecsArray as! [Mat])
        tvecs.removeAll()
        tvecs.append(contentsOf: tvecsArray as! [Mat])
...
public extension Calib3d {
    @nonobjc class func fisheye_stereoCalibrate(objectPoints: [Mat], imagePoints1: [Mat], imagePoints2: [Mat], K1: Mat, D1: Mat, K2: Mat, D2: Mat, imageSize: Size2i, R: Mat, T: Mat, rvecs: inout [Mat], tvecs: inout [Mat]) -> Double {
        let rvecsArray = NSMutableArray(array: rvecs)
        let tvecsArray = NSMutableArray(array: tvecs)
        let ret = Calib3d.fisheye_stereoCalibrate(objectPoints: objectPoints, imagePoints1: imagePoints1, imagePoints2: imagePoints2, K1: K1, D1: D1, K2: K2, D2: D2, imageSize: imageSize, R: R, T: T, rvecs: rvecsArray, tvecs: tvecsArray)
        rvecs.removeAll()
        rvecs.append(contentsOf: rvecsArray as! [Mat])
        tvecs.removeAll()
        tvecs.append(contentsOf: tvecsArray as! [Mat])
