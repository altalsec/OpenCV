...
public extension ArucoDetector {
    @nonobjc func detectMarkersWithConfidence(image: Mat, corners: inout [Mat], ids: Mat, markersConfidence: Mat, rejectedImgPoints: inout [Mat]) -> Void {
        let cornersArray = NSMutableArray(array: corners)
        let rejectedImgPointsArray = NSMutableArray(array: rejectedImgPoints)
        detectMarkersWithConfidence(image: image, corners: cornersArray, ids: ids, markersConfidence: markersConfidence, rejectedImgPoints: rejectedImgPointsArray)
        corners.removeAll()
        corners.append(contentsOf: cornersArray as! [Mat])
        rejectedImgPoints.removeAll()
        rejectedImgPoints.append(contentsOf: rejectedImgPointsArray as! [Mat])
...
public extension ArucoDetector {
    @nonobjc func detectMarkersWithConfidence(image: Mat, corners: inout [Mat], ids: Mat, markersConfidence: Mat) -> Void {
        let cornersArray = NSMutableArray(array: corners)
        detectMarkersWithConfidence(image: image, corners: cornersArray, ids: ids, markersConfidence: markersConfidence)
        corners.removeAll()
        corners.append(contentsOf: cornersArray as! [Mat])
    }
}
...
public extension ArucoDetector {
    @nonobjc func detectMarkersMultiDict(image: Mat, corners: inout [Mat], ids: Mat, rejectedImgPoints: inout [Mat], dictIndices: Mat) -> Void {
        let cornersArray = NSMutableArray(array: corners)
        let rejectedImgPointsArray = NSMutableArray(array: rejectedImgPoints)
        detectMarkersMultiDict(image: image, corners: cornersArray, ids: ids, rejectedImgPoints: rejectedImgPointsArray, dictIndices: dictIndices)
        corners.removeAll()
        corners.append(contentsOf: cornersArray as! [Mat])
        rejectedImgPoints.removeAll()
        rejectedImgPoints.append(contentsOf: rejectedImgPointsArray as! [Mat])
...
public extension ArucoDetector {
    @nonobjc func detectMarkersMultiDict(image: Mat, corners: inout [Mat], ids: Mat, rejectedImgPoints: inout [Mat]) -> Void {
        let cornersArray = NSMutableArray(array: corners)
        let rejectedImgPointsArray = NSMutableArray(array: rejectedImgPoints)
        detectMarkersMultiDict(image: image, corners: cornersArray, ids: ids, rejectedImgPoints: rejectedImgPointsArray)
        corners.removeAll()
        corners.append(contentsOf: cornersArray as! [Mat])
        rejectedImgPoints.removeAll()
        rejectedImgPoints.append(contentsOf: rejectedImgPointsArray as! [Mat])
...
public extension ArucoDetector {
    @nonobjc func detectMarkersMultiDict(image: Mat, corners: inout [Mat], ids: Mat) -> Void {
        let cornersArray = NSMutableArray(array: corners)
        detectMarkersMultiDict(image: image, corners: cornersArray, ids: ids)
        corners.removeAll()
        corners.append(contentsOf: cornersArray as! [Mat])
    }
}
