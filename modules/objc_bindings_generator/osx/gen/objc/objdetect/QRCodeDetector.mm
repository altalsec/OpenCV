...
- (ECIEncodings)getEncoding:(int)codeIdx {
    cv::QRCodeEncoder::ECIEncodings retVal = self.nativePtrQRCodeDetector->getEncoding(codeIdx);
    return (ECIEncodings)retVal;
}

- (ECIEncodings)getEncoding {
    cv::QRCodeEncoder::ECIEncodings retVal = self.nativePtrQRCodeDetector->getEncoding();
    return (ECIEncodings)retVal;
}
