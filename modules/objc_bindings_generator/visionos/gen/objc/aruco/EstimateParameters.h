...
#import "C:/opencv/opencv\../opencv_contrib/modules/aruco\include\opencv2\aruco\aruco_calib.hpp"
#else
#define CV_EXPORTS
#endif
...
- (instancetype)init;
    ...
    //
    // C++: aruco_PatternPositionType cv::aruco::EstimateParameters::pattern
    //
