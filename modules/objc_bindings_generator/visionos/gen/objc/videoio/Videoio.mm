...
+ (int)CAP_PROP_GIGA_FRAME_HEIGHT_MAX {
    return 10004;
}

+ (int)CAP_PROP_GIGA_FRAME_HEIGH_MAX {
    return Videoio.CAP_PROP_GIGA_FRAME_HEIGHT_MAX;
}
...
+ (int)CAP_PROP_GIGA_FRAME_SENS_HEIGHT {
    return 10006;
}

+ (int)CAP_PROP_GIGA_FRAME_SENS_HEIGH {
    return Videoio.CAP_PROP_GIGA_FRAME_SENS_HEIGHT;
}
