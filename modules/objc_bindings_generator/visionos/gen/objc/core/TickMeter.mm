...
- (long)getLastTimeTicks {
    int64 retVal = self.nativePtr->getLastTimeTicks();
    return retVal;
}
...
- (double)getLastTimeMicro {
    double retVal = self.nativePtr->getLastTimeMicro();
    return retVal;
}
...
- (double)getLastTimeMilli {
    double retVal = self.nativePtr->getLastTimeMilli();
    return retVal;
}
...
- (double)getLastTimeSec {
    double retVal = self.nativePtr->getLastTimeSec();
    return retVal;
}
