...
//
+ (double)findTransformECCWithMask:(Mat*)templateImage inputImage:(Mat*)inputImage templateMask:(Mat*)templateMask inputMask:(Mat*)inputMask warpMatrix:(Mat*)warpMatrix motionType:(int)motionType criteria:(TermCriteria*)criteria gaussFiltSize:(int)gaussFiltSize {
    double retVal = cv::findTransformECCWithMask(templateImage.nativeRef, inputImage.nativeRef, templateMask.nativeRef, inputMask.nativeRef, warpMatrix.nativeRef, motionType, criteria.nativeRef, gaussFiltSize);
    return retVal;
}

+ (double)findTransformECCWithMask:(Mat*)templateImage inputImage:(Mat*)inputImage templateMask:(Mat*)templateMask inputMask:(Mat*)inputMask warpMatrix:(Mat*)warpMatrix motionType:(int)motionType criteria:(TermCriteria*)criteria {
    double retVal = cv::findTransformECCWithMask(templateImage.nativeRef, inputImage.nativeRef, templateMask.nativeRef, inputMask.nativeRef, warpMatrix.nativeRef, motionType, criteria.nativeRef);
    return retVal;
}

+ (double)findTransformECCWithMask:(Mat*)templateImage inputImage:(Mat*)inputImage templateMask:(Mat*)templateMask inputMask:(Mat*)inputMask warpMatrix:(Mat*)warpMatrix motionType:(int)motionType {
    double retVal = cv::findTransformECCWithMask(templateImage.nativeRef, inputImage.nativeRef, templateMask.nativeRef, inputMask.nativeRef, warpMatrix.nativeRef, motionType);
    return retVal;
}

+ (double)findTransformECCWithMask:(Mat*)templateImage inputImage:(Mat*)inputImage templateMask:(Mat*)templateMask inputMask:(Mat*)inputMask warpMatrix:(Mat*)warpMatrix {
    double retVal = cv::findTransformECCWithMask(templateImage.nativeRef, inputImage.nativeRef, templateMask.nativeRef, inputMask.nativeRef, warpMatrix.nativeRef);
    return retVal;
}
