...
//
+ (GFTTDetector*)create:(int)maxCorners qualityLevel:(double)qualityLevel minDistance:(double)minDistance blockSize:(int)blockSize gradientSize:(int)gradientSize useHarrisDetector:(BOOL)useHarrisDetector k:(double)k {
    cv::Ptr<cv::GFTTDetector> retVal = cv::GFTTDetector::create(maxCorners, qualityLevel, minDistance, blockSize, gradientSize, (bool)useHarrisDetector, k);
    return [GFTTDetector fromNative:retVal];
}

+ (GFTTDetector*)create:(int)maxCorners qualityLevel:(double)qualityLevel minDistance:(double)minDistance blockSize:(int)blockSize gradientSize:(int)gradientSize useHarrisDetector:(BOOL)useHarrisDetector {
    cv::Ptr<cv::GFTTDetector> retVal = cv::GFTTDetector::create(maxCorners, qualityLevel, minDistance, blockSize, gradientSize, (bool)useHarrisDetector);
    return [GFTTDetector fromNative:retVal];
}

+ (GFTTDetector*)create:(int)maxCorners qualityLevel:(double)qualityLevel minDistance:(double)minDistance blockSize:(int)blockSize gradientSize:(int)gradientSize {
    cv::Ptr<cv::GFTTDetector> retVal = cv::GFTTDetector::create(maxCorners, qualityLevel, minDistance, blockSize, gradientSize);
    return [GFTTDetector fromNative:retVal];
}
